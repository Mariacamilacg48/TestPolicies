...
namespace GAPTest.Web.Migrations
{
    ...
    [Migration("20200825004609_FixingDBModel")]
    partial class FixingDBModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GAPTest.Web.Data.Entities.Manager", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("GAPTest.Web.Data.Entities.User", b =>
                {
            ...
            modelBuilder.Entity("GAPTest.Web.Data.Entities.Customer", b =>
                {
                    b.HasOne("GAPTest.Web.Data.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GAPTest.Web.Data.Entities.User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
